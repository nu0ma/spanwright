...
import { parseCommandLineArgs, checkForHelpAndVersion, showVersion, showHelp, showUsageError, isNonInteractiveMode } from '../cli'
...
describe('CLI Module', () => {
  beforeEach(() => {
    ...
    mockSafeExit.mockImplementation(() => { throw new Error('safeExit called') })
