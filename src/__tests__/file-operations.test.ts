...
describe('File Operations Module', () => {
  ...
  describe('safeFileRename', () => {
    ...
    it('should throw FileSystemError if rename fails', () => {
      ...
      expect(() => safeFileRename(oldPath, newPath)).toThrow('Failed to rename file from /test/old.txt to /test/new.txt')
    })
  ...
  describe('writeFileContent', () => {
    ...
    it('should throw FileSystemError if file write fails', () => {
      ...
      expect(() => writeFileContent(filePath, content)).toThrow('Failed to write file: /test/file.txt')
    })
  ...
  describe('replaceInFile', () => {
    ...
    it('should throw FileSystemError if file read fails', () => {
      ...
      expect(() => replaceInFile(filePath, { 'PROJECT_NAME': 'MyProject' })).toThrow('Failed to read file: /test/file.txt')
    })
    ...
    it('should throw FileSystemError if file write fails', () => {
      ...
      expect(() => replaceInFile(filePath, { 'PROJECT_NAME': 'MyProject' })).toThrow(FileSystemError)
      expect(() => replaceInFile(filePath, { 'PROJECT_NAME': 'MyProject' })).toThrow('Failed to write file: /test/file.txt')
    })
  })
  ...
  describe('replaceProjectNameInGoFiles', () => {
    ...
    it('should throw FileSystemError if directory read fails', () => {
      ...
      expect(() => replaceProjectNameInGoFiles(projectPath, projectName)).toThrow('Failed to process directory: /test/project')
    })
  ...
  describe('removeSecondaryDbFiles', () => {
    it('should remove secondary database files', () => {
      ...
      const expectedFiles = [
        ...
        path.join(projectPath, 'scenarios', 'example-01-basic-setup', 'seed-data', 'secondary-seed.json'),
