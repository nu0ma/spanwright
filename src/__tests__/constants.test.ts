...
describe('Constants Module', () => {
  ...
  describe('MESSAGES', () => {
    ...
    describe('INFO', () => {
      it('should have info messages', () => {
        ...
        expect(MESSAGES.INFO.REMOVING_FILES).toBe('🗑️  Removing unnecessary files (Single DB configuration)...')
    ...
    describe('USAGE', () => {
      it('should have usage messages', () => {
        ...
        expect(MESSAGES.USAGE.HELP_SUGGESTION).toBe('Try "spanwright --help" for more information.')
      })
    })
  })
  ...
  describe('Message Function Testing', () => {
    it('should generate directory exists message with different names', () => {
      expect(MESSAGES.ERRORS.DIRECTORY_EXISTS('my-project')).toBe('❌ Directory "my-project" already exists')
      expect(MESSAGES.ERRORS.DIRECTORY_EXISTS('test-app')).toBe('❌ Directory "test-app" already exists')
    ...
    it('should handle special characters in directory names', () => {
      expect(MESSAGES.ERRORS.DIRECTORY_EXISTS('project-with-dashes')).toBe('❌ Directory "project-with-dashes" already exists')
      expect(MESSAGES.ERRORS.DIRECTORY_EXISTS('project_with_underscores')).toBe('❌ Directory "project_with_underscores" already exists')
    })
  })
})