...
import { SpanwrightError, ValidationError, FileSystemError, ConfigurationError, handleError, safeExit } from '../errors'
...
describe('Errors Module', () => {
  ...
  describe('handleError', () => {
    ...
    it('should handle generic Error', () => {
      ...
      expect(() => handleError(error)).toThrow('process.exit called')
      expect(mockConsoleError).toHaveBeenCalledWith('❌ An error occurred:', 'Generic error message')
      expect(mockProcessExit).toHaveBeenCalledWith(1)
    })
    ...
    it('should prioritize SpanwrightError handling over generic Error', () => {
      ...
      expect(mockConsoleError).not.toHaveBeenCalledWith(expect.stringContaining('❌ An error occurred:'))
      expect(mockProcessExit).toHaveBeenCalledWith(1)
    })
  })
